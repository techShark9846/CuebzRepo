...
export default function RolesUserFilters({
  filters,
  setFilters,
  onApplyFilters,
  table,
  ...
  return (
    <Flex align="center" justify="between" className="mb-4">
      ...
      <FilterDrawerView
        isOpen={openDrawer}
        drawerTitle="Roles User Filters"
      ...
      >
        <div className="grid grid-cols-1 gap-6">
          ...
          <div>
            ...
            <DatePicker
              selected={
                localFilters.createdAt ? new Date(localFilters.createdAt) : null
              }
              onChange={(date: Date | null) => {
                setLocalFilters((prev: any) => ({
                  ...prev,
                  createdAt: date ? date.toISOString().split("T")[0] : null, // Store only the date part
                }));
              }}
